...
import 'package:fashionhind/custom/box_decorations.dart';
import 'package:fashionhind/custom/btn.dart';
import 'package:fashionhind/custom/device_info.dart';
import 'package:fashionhind/custom/enum_classes.dart';
import 'package:fashionhind/custom/fade_network_image.dart';
import 'package:fashionhind/custom/lang_text.dart';
import 'package:fashionhind/custom/scroll_to_hide_widget.dart';
import 'package:fashionhind/custom/useful_elements.dart';
import 'package:fashionhind/data_model/carriers_response.dart';
import 'package:fashionhind/data_model/delivery_info_response.dart';
import 'package:fashionhind/helpers/system_config.dart';
import 'package:fashionhind/repositories/cart_repository.dart';
import 'package:fashionhind/repositories/pickup_points_repository.dart';
import 'package:fashionhind/repositories/shipping_repository.dart';
import 'package:fashionhind/screens/checkout.dart';
...
import 'package:fashionhind/repositories/address_repository.dart';
import 'package:fashionhind/helpers/shimmer_helper.dart';
import 'package:fashionhind/data_model/city_response.dart';
import 'package:fashionhind/data_model/country_response.dart';
...
*/
  ...
  Container buildAppbarTitle(BuildContext context) {
    return Container(
      ...
      child: Text(
        "${AppLocalizations.of(context)!.shipping_info_screen_shipping_cost} ${SystemConfig.systemCurrency != null ? _shipping_cost_string.replaceAll(SystemConfig.systemCurrency.code, SystemConfig.systemCurrency.symbol) : _shipping_cost_string}",
        style: TextStyle(
            fontSize: 16,
            color: MyTheme.dark_font_grey,
            fontWeight: FontWeight.bold),
